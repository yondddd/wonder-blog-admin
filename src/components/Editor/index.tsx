...
interface BaseEditorProps {
  ...
  hideSettings?: boolean;  // 控制是否隐藏设置按钮
  hideComments?: boolean;  // 控制是否隐藏评论功能
}
  ...
  return (
    <>
      ...
      >
        ...
        <SpeechToTextPlugin />
        <AutoLinkPlugin />
        {!hideComments && <CommentPlugin providerFactory={isCollab ? createWebsocketProvider : undefined} />}
        {isRichText ? (
          <>
            {isCollab ? (
              <CollaborationPlugin
      ...
      <TableContext>
        <ToolbarContext>
          <div className="editor-shell">
            <Editor debug={debug} showTableOfContent={showTableOfContent} hideComments={hideComments}>
              {children}
            </Editor>
          </div>
